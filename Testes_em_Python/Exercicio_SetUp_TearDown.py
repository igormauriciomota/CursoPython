...
class Tatu:
    ...
    def comer(self):
        return f'Sou {self.__nome} e estou comendo pizza'
    
    def beber(self):
        return f'Sou {self.__nome} e estou bebendo suco'
    
    def cavar(self):
        return f'Sou {self.__nome} e estou cavando sua grama'
    
    def acasalar(self):
        return f'Sou {self.__nome} e quero um filhote'
